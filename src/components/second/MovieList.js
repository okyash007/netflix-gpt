    ...
    <div className="m-6 max-lg:m-3 " >
      <div  >
        ...
        <div className="flex overflow-x-scroll edit-schroll " >
          {movies.map((movies) =>(<MovieCard path={movies.poster_path} key={movies.id} />) )}
          <div className="bg-gradient-to-l from-black w-56 max-sm:w-12 h-60 z-10 absolute right-0 mr-6 max-sm:mr-3 "></div>
