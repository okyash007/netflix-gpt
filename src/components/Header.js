...
const Header = () => {
  ...
  return (
    <>
      <div className="w-full h-96 max-sm:h- absolute z-10 bg-gradient-to-b from-black max-sm:from-red-950">
        <img
      ...
      <form onSubmit={(e)=> e.preventDefault() } className="flex flex-col p-14 bg-black absolute z-40 m-auto top-0 bottom-0 right-0 left-0 h-3/4 w-96 text-white rounded bg-opacity-80 max-sm:w-full max-sm:h-full max-sm:z-0 max-sm:py-28">
